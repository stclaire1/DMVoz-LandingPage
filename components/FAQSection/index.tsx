...
const FAQSection = () => {
    return (
        <section className="w-full flex flex-col gap-10 p-10 sm:px-15 sm:py-15 lg:flex-row lg:gap-20 lg:items-start lg:px-20 lg:py-20 xl:px-30 xl:gap-26 2xl:max-w-[1580px]" id="faqSection">
            <div>
