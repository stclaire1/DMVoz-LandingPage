                            ...
                            <CarouselItem key={video.videoId}>
                                <div className="flex flex-col items-center gap-3 md:flex-row md:gap-10 lg:px-3 2xl:gap-24">
                                    ...
                                    <div className="flex flex-col gap-4 text-center md:text-start">
                                        <h3 className="mt-3 text-xl font-semibold md:mt-0 lg:text-2xl 2xl:text-3xl">{video.title}</h3>
                                        <p className="text-justify text-sm lg:text-base">{video.description}</p>
                                    </div>
                                </div>
                            </CarouselItem>
                        ))}
