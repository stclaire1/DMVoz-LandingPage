...
const TestimonialCard = ({ author, testimonial, logo }: TestimonialCardProps) => {
    return (
        <div className="flex flex-col items-center justify-between gap-6 text-center h-full border border-[#1D0200] rounded-lg p-7 shadow-lg bg-orange-100 backdrop-blur-sm">
